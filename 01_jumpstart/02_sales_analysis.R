...
# JUMPSTART Frist Sales Analysis----
...
bike_orderlines_wrangled %>% glimpse()
...
sales_by_year_cat_2_tbm <- bike_orderlines_wrangled_tbl %>% 
...
sales_by_year_cat_2_tbm %>% 
    ...
    labs(
        ...
        x = "",
        y = "Revenue",
        fill = "Product Scondary Category"
    )
...
bike_orderlines_wrangled_tbl %>% 
    write_xlsx("00_data/bike_sales/data_wrangled_student/bike_orderlines_xlsx")
