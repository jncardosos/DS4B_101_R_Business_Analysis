...
bike_orderlines_tbl %>% 
    filter(category_2 %in% c("Over Monutain", "Trail", "Endurance Road"))
...
bikes_revenue_tbl <- bike_orderlines_tbl %>% 
...
bikeshop_revenue_formatted <- bikes_revenue_tbl %>% 
